...
RSpec.describe 'Creating a book', type: :feature do
  ...
  scenario 'valid inputs' do
    fill_in_book_form(title: 'Harry Potter', author: 'J.K Rowling', price: '25.0', pdate_year: '1997',
                      pdate_month: 'June', pdate_day: '26')
  ...
  scenario 'creating book with missing title' do
    fill_in_book_form(title: '', author: 'J.K Rowling', price: '25.0', pdate_year: '1997', pdate_month: 'June',
                      pdate_day: '26')
    click_on 'Create Book'
  ...
  scenario 'creating book with missing author' do
    fill_in_book_form(title: 'Harry Potter', author: '', price: '25.0', pdate_year: '1997', pdate_month: 'June',
                      pdate_day: '26')
    click_on 'Create Book'
  ...
  scenario 'creating book with missing price' do
    fill_in_book_form(title: 'Harry Potter', author: 'J.K Rowling', price: '', pdate_year: '1997', pdate_month: 'June',
                      pdate_day: '26')
    click_on 'Create Book'
  ...
  scenario 'creating book with missing pdate' do
    fill_in_book_form(title: 'Harry Potter', author: 'J.K Rowling', price: '25.0', pdate_year: '', pdate_month: '',
                      pdate_day: '')
    click_on 'Create Book'
